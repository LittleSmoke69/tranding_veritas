...
import { B, BD, BB, GD, MFG, FG, BORDER, IBox, Badge, SectionHeader, type LandingView } from "../shared";
...
export default function QuemSomos({ onNavigate }: { onNavigate: (v: LandingView) => void }) {
  return (
    <>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <button onClick={() => onNavigate("nossaequipe")} className="block mx-auto mt-4" style={{ fontSize: "0.75rem", fontWeight: 500, color: MFG }}>
