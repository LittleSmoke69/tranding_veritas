...
import { B, BD, BB, BORDER, Badge, type LandingView } from "../shared";
...
export default function NossaEquipe({ onNavigate }: { onNavigate: (v: LandingView) => void }) {
  return (
    <>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="bento-card p-10">
            ...
            <button onClick={() => onNavigate("carreiras")} className="inline-flex items-center gap-2 px-6 py-3 rounded-xl hover:opacity-90"
