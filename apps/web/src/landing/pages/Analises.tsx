  ...
  return (
    <section className="py-24 relative overflow-hidden" style={{ background: BG }}>
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        <PrimaryButton onClick={() => onNavigate("planos")}>Ver planos disponíveis <ArrowRight className="w-4 h-4" /></PrimaryButton>
      </div>
    </section>
  );
}
...
// ── Página completa ────────────────────────────────────────────────────────────
export default function Analises({ onNavigate }: { onNavigate: (v: LandingView) => void }) {
  return (
    <>
      <HeroAnalises />
