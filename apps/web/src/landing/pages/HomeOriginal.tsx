...
import {
  ...
  IBox, Badge, SectionHeader, useCountUp, BrokersSection, type LandingView,
} from "../shared";
    ...
    <section className="py-24 border-t" style={{ borderColor: BORDER }}>
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <button onClick={() => onNavigate("planos")} className="px-6 py-3 rounded-xl hover:opacity-90"
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {MODULOS_PREVIEW.map((m) => (
            <div key={m.title} className="bento-card group relative h-56 overflow-hidden cursor-pointer" onClick={() => onNavigate("educacao")}>
        ...
        <div className="text-center">
          <button onClick={() => onNavigate("educacao")} className="inline-flex items-center gap-2" style={{ fontSize: "0.9375rem", fontWeight: 700, color: B }}>
      ...
      <section className="py-24 border-t relative overflow-hidden" style={{ borderColor: BORDER, background: CARD }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
            <button onClick={onAccessPlatform} className="px-7 py-4 rounded-xl hover:opacity-90"
              style={{ background: B, color: "#fff", fontSize: "0.9375rem", fontWeight: 700, boxShadow: "0 0 40px var(--primary-glow)" }}>
              Começar agora
            </button>
      ...
      <section className="py-24 border-t" style={{ borderColor: BORDER }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-14">
            <button onClick={() => onNavigate("planos")} className="px-7 py-4 rounded-xl hover:opacity-90"
              style={{ background: B, color: "#fff", fontSize: "0.9375rem", fontWeight: 700, boxShadow: "0 0 40px var(--primary-glow)" }}>
              Abrir Conta Internacional
            </button>
            <button onClick={() => onNavigate("planos")} className="px-7 py-4 rounded-xl border" style={{ borderColor: BORDER, color: FG, fontSize: "0.9375rem", fontWeight: 600 }}>
              Conhecer os Planos
            </button>
            <button className="px-7 py-4 rounded-xl border" style={{ borderColor: BORDER, color: FG, fontSize: "0.9375rem", fontWeight: 600 }}>
