...
import { B, BD, BB, MFG, FG, BORDER, IBox, Badge, SectionHeader, navigate } from "../shared";
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bento-card p-8 md:p-12 grid md:grid-cols-[1.1fr_1fr] gap-10 items-center">
            <div>
              ...
              <button onClick={() => navigate("/planos")} className="mt-6 inline-flex items-center gap-2 px-6 py-3 rounded-xl hover:opacity-90"
