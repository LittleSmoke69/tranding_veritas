...
import { useCountUp, BrokersSection, PLATFORM_URL, navigate } from "../shared";
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <PrimaryButton href={PLATFORM_URL}>Abrir Conta <ArrowRight className="w-4 h-4" /></PrimaryButton>
    ...
    <section className="py-24" style={{ background: BG }}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {MODULOS_PREVIEW.map((m) => (
            <div key={m.title} className="rounded-2xl border group relative h-56 overflow-hidden cursor-pointer"
              style={{ borderColor: BORDER }} onClick={() => navigate("/educacao")}>
        ...
        <div className="text-center">
          <button onClick={() => navigate("/educacao")} className="inline-flex items-center gap-2" style={{ fontSize: "0.9375rem", fontWeight: 700, color: BLUE_LIGHT }}>
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <button onClick={() => navigate("/planos")} className="w-full py-4 rounded-full hover:opacity-90"
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: BG }}>
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
            <PrimaryButton href={PLATFORM_URL}>Começar agora</PrimaryButton>
      ...
      <section className="py-24" style={{ background: BG }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-14">
            <PrimaryButton onClick={() => navigate("/planos")}>Abrir Conta Internacional</PrimaryButton>
            <SecondaryButton onClick={() => navigate("/planos")}>Conhecer os Planos</SecondaryButton>
